...
void uart_putc( char data ) {
    ...
    tmp_head  = (UART_TxHead + 1) & UART_TX_BUF_MASK;
          ...
          // p�tla oczekuje je�eli brak miejsca w buforze cykl#define USI_PORT DDRB
#define DO PB6	//   <---- A (SER IN)
#define DI PB5	//   <---- A (SER IN)
#define SCK PB7		//   <---- SHIFT CLOCK (SC)
#define CS PB2		//	 <---- LATCH CLOCK (LC)icznym na kolejne znaki
